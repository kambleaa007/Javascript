...
public class EmployeeDAOIMPL implements EmployeeDAO {
	...
	private static  Logger logger =  LoggerFactory.getLogger("EmployeeDAOIMPLActual");

	private static  Map<Integer, Employee> mapOfEmloyees = new LinkedHashMap<Integer, Employee>();
